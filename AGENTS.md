...
- Any UI or design-related work must consult `frontend/DESIGN.md` first and follow it exactly. This applies to layout, visual hierarchy, colors, spacing, typography, buttons, cards, tables, forms, responsive behavior, and any other user-facing design detail.
- Internal docs are local-only by default and must be excluded from commits unless the user explicitly requests otherwise:
  - `memory/**`
  - `docs/portfolio/**`
  - `docs/decisions/**`
